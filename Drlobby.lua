    ...
    for _, zone in ipairs(zones) do
        ...
        if hitbox and not isZoneOccupied(hitbox) then
            ...
            if character and character:FindFirstChild("HumanoidRootPart") then
                -- Teleport ไป Zone ว่าง
                character:FindFirstChild("HumanoidRootPart").CFrame = hitbox.CFrame + Vector3.new(0, 5, 0)
                task.wait(0.5) -- หน่วงนิดเพื่อให้ตำแหน่งเซ็ตก่อน
                -- ยิง RemoteEvent เพื่อสร้างปาร์ตี้
